...
void t_soln()
{
    ...
    if (x1 < 1 || y1 > n)
    {
        cout << min(min(n + 1 - x2, n + 1 - y2), min(x2, y2)) << '\n';
        return;
    }
    if (x2 < 1 || y2 > n)
    {
        cout << min(min(n + 1 - x1, n + 1 - y1), min(x1, y1)) << '\n';
        return;
    }
    ll t1 = min(min(x1, y1), min(n + 1 - x1, n + 1 - y1));
    ll t2 = min(min(x2, y2), min(n + 1 - x2, n + 1 - y2));
    cout << min(t1 + t2, abs(x2 - x1) + abs(y2 - y1)) << '\n';
}
